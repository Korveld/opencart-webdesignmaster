  ...
  'add': function(product_id, quantity) {
    $.ajax({
      ...
      success: function(json) {
        ...
        if (json['success']) {
          $('#content').parent().before('<div class="success-add alert alert-success alert-dismissible"><i class="fa fa-check-circle"></i> ' + json['success'] + ' <button type="button" class="close" data-dismiss="alert">&times;</button></div>');

          setTimeout(function () {
            $('.success-add').addClass('fade-in')
          }, 100);

          setTimeout(function () {
            $('.success-add').removeClass('fade-in')
          }, 1000);
...
jQuery(document).ready(function ($) {
  ...
  $(document).on('click', function (e) {
    if ( (e.target.id !== 'cart' && $(e.target).parents('#cart').length === 0) ) {
  ...
  $('.product-layout .product-thumb').each(function (e) {
    ...
    $(this).after('<div id="pp-item-' + e + '" class="product-popup">' +
      '<h2>Купить в один клик</h2>' +
        ...
        '<form class="ajax-form">' +
          ...
          '<input class="form-control" type="tel" name="Телефон" placeholder="Введите ваш телефон..." required>' +
    ...
    $(this)
      .find('.button-group')
      .append('<a href="#pp-item-' + e + '" class="button toclick">Купить в один клик</a>');
    $(this)
      .parent()
      .attr({
